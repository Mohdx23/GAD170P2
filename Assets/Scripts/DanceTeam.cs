...
public class DanceTeam : MonoBehaviour
{
    ...
    public void AddNewDancer(Character dancer)
    {
        ...
        //this code is called when a new dancer has to be added to the battle.
    }
    ...
    public void RemoveFromActive(Character dancer)
    {
        ...
        //this code is incharge of removing dancers from the active teams incase of a defeat to keep the game going.    
    }
