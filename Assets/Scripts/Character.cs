...
public class Character : MonoBehaviour
{
    ...
    //this code names all the stats that a character would have and it shows you the available points that they have at the start.
    ...
    public void InitialStats()
    {
        ...
        rhythm = Random.Range(2, 6);

        availablePoints -= rhythm;
        luck = availablePoints;
        //this code is used to randomly assign stats to the characters by using a formula that generates a random number and assigns it.
